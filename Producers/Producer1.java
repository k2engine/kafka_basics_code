...
public class Producer1 {
    ...
    private static final Logger log = LoggerFactory.getLogger(Producer1.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        ProducerRecord<String,String> producerRecord = new ProducerRecord<>("demo_java","hello... this is the data value");
